...
#End Region
    ...
    Private Async Function ViewDataAsync() As Task
        ...
        Try
            ...
            Dim chkDate As Date = startDate.Date
            While chkDate <= endDate
                dt = Nothing
                Dim tempStartDate As Date = chkDate
                Dim tempEndDate As Date = New Date(chkDate.Year, chkDate.Month, Date.DaysInMonth(chkDate.Year, chkDate.Month))
