...
Public Class SqueezeZone
    ...
    Public Overrides Async Function RunAsync(ByVal startDate As Date, ByVal endDate As Date) As Task(Of DataTable)
        ...
        ret.Columns.Add("Start Time")
        ret.Columns.Add("End Time")
                ...
                For Each stock In stockList
                    ...
                    If stockPayload IsNot Nothing AndAlso stockPayload.Count > 0 Then
                        ...
                        If currentDayPayload IsNot Nothing AndAlso currentDayPayload.Count > 0 Then
                            ...
                            Indicator.ATRBands.CalculateATRBands(1, 50, Payload.PayloadFields.Close, inputPayload, atrHighPayload, atrLowPayload)
                            ...
                            Dim previousCondition As Boolean = False
                            For Each runningPayload In currentDayPayload.Keys
                                _canceller.Token.ThrowIfCancellationRequested()

                                Dim condition As Boolean = bollingerHighPayload(runningPayload) < atrHighPayload(runningPayload) AndAlso bollingerLowPayload(runningPayload) > atrLowPayload(runningPayload)
                                If condition Then
                                    If Not previousCondition Then startTime = runningPayload
                                Else
                                    If previousCondition Then
                                        ...
                                        row("Start Time") = startTime.ToString("HH:mm:ss")
                                        row("End Time") = runningPayload.ToString("HH:mm:ss")
