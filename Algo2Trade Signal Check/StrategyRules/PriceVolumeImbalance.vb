...
Public Class PriceVolumeImbalance
    Inherits Rule
    ...
    Public Overrides Async Function RunAsync(ByVal startDate As Date, ByVal endDate As Date) As Task(Of DataTable)
        ...
        ret.Columns.Add("(High-Low)/Volume")
        ret.Columns.Add("MA")
        ret.Columns.Add("SD")
        ret.Columns.Add("+ xSD")
        ret.Columns.Add("- xSD")
        ret.Columns.Add("Condition")
                ...
                For Each stock In stockList
                    ...
                    If stockPayload IsNot Nothing AndAlso stockPayload.Count > 0 Then
                        ...
                        If currentDayPayload IsNot Nothing AndAlso currentDayPayload.Count > 0 Then
                            Dim highLowVolPayload As Dictionary(Of Date, Decimal) = Nothing
                            ...
                            Indicator.StandardDeviation.CalculateSD(_period, Payload.PayloadFields.Additional_Field, highLowVolConPayload, sdPayload)
