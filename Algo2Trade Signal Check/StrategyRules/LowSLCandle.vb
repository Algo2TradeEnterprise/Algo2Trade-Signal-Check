                ...
                For Each stock In stockList
                    ...
                    If stockPayload IsNot Nothing AndAlso stockPayload.Count > 0 Then
                        ...
                        If currentDayPayload IsNot Nothing AndAlso currentDayPayload.Count > 0 Then
                            Dim lotSize As Integer = _cmn.GetLotSize(Common.DataBaseTable.Intraday_Futures, currentDayPayload.FirstOrDefault.Value.TradingSymbol, currentDayPayload.FirstOrDefault.Key.Date)
