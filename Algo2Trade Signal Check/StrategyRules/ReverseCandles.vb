                            ...
                            For Each runningPayload In currentDayPayload.Keys
                                ...
                                If currentDayPayload(runningPayload).PreviousCandlePayload IsNot Nothing Then
                                    If currentDayPayload(runningPayload).CandleColor = Color.Red AndAlso
                                        ...
                                        row("Color") = currentDayPayload(runningPayload).CandleColor.Name
                                        ret.Rows.Add(row)
                                    ElseIf currentDayPayload(runningPayload).CandleColor = Color.Green AndAlso
