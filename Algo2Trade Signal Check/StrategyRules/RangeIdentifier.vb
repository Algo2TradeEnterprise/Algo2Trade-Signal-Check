...
Public Class RangeIdentifier
    ...
    Public Overrides Async Function RunAsync(ByVal startDate As Date, ByVal endDate As Date) As Task(Of DataTable)
        ...
        ret.Columns.Add("High Range")
        ret.Columns.Add("Low Range")
                ...
                For Each stock In stockList
                    ...
                    If stockPayload IsNot Nothing AndAlso stockPayload.Count > 0 Then
                        ...
                        If currentDayPayload IsNot Nothing AndAlso currentDayPayload.Count > 0 Then
                            Dim highRangePayloads As Dictionary(Of Date, Decimal) = Nothing
                            Dim lowRangePayloads As Dictionary(Of Date, Decimal) = Nothing
                            Indicator.RangeIdentifier.CalculateRangeIdentifier(inputPayload, highRangePayloads, lowRangePayloads)
                            ...
                            For Each runningPayload In currentDayPayload.Keys
                                ...
                                row("High Range") = highRangePayloads(runningPayload)
                                row("Low Range") = lowRangePayloads(runningPayload)
